...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('https://event-info-application.onrender.com/api/auth/login', formData);
  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-md p-6 rounded-lg mt-10">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-blue-500 text-white font-semibold py-2 rounded hover:bg-blue-600">Login</button>
